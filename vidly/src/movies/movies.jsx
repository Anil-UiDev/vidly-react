...
class Movies extends Component {
    ...
    render() {
        ...
        if (moviesCount === 0) return <span>There are no movies in the database</span>;
        ...
        return (
            <div className="row">
                ...
                <div className="col">
                    ...
                    <span>Showing <i>{totalCount}</i> movies in the database</span>
                    <SearchBox value={searchQuery} onChange={this.handleSearch} />
                    <MovieList movies={movies} sortColumn={sortColumn} onLike={this.handleLike} onDelete={this.deleteRow} onSort={this.handleSort} />
